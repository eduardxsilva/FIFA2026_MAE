# FIFA 2026 Analytics Engine

Aplicação web para análise estatística, previsão de partidas e simulação da Copa do Mundo de 2026. O sistema usa uma base histórica de jogos para estimar a força das equipes, calcular probabilidades de vitória, empate e derrota, projetar placares e executar simulações Monte Carlo do torneio.
...
1. Acesse **Importar dados** e carregue um arquivo CSV/XLSX ou use a extração online.
